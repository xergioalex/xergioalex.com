...
| `tags` | Present, array — 1-3 primary, 1-10 secondary, 0-15 subtopic (≥1 primary AND ≥1 secondary required), every tag exists in `src/content/tags/` | FAIL if tag does not exist; WARN if >3 primary, >10 secondary, or >15 subtopic; WARN if no primary OR no secondary tag. See [Tag governance](../../../docs/features/BLOG_POSTS.md#tag-taxonomy-unified-collection) |
