...
Everything above acts *after* the vulnerability exists. The axis opening up in parallel, and the more uncomfortable one, is the discovery side.

In April 2026, Anthropic announced [Claude Mythos Preview](https://red.anthropic.com/2026/mythos-preview/) — a model that found thousands of zero-days across Windows, macOS, Linux, Chrome, Firefox, and Safari, several of them buried in code that had been published for over two decades. The economics of the finding is what's new: the OpenBSD bug cost the model about $50 to discover; taking total control of a FreeBSD server — discovery, exploit, and privilege escalation chained without human intervention — came in under $2,000. Faced with the same task of finding flaws in Firefox, Anthropic's prior model produced 2 working exploits; Mythos, 181. [Anthropic decided not to release the model](https://www.anthropic.com/glasswing) and instead assembled a $100M defensive coalition — Apple, Google, Microsoft, Amazon, and others — to patch the world before Mythos, or an unrestrained equivalent, ends up in attacker hands. I unpacked the full release in *[Claude Mythos: The Model Too Dangerous to Release](/blog/claude-mythos-the-model-too-dangerous-to-release/)*.

What matters for this post: supply-chain defense rests on a temporal asymmetry — maintainers take months to find bugs, and attackers take months too. When an attacker with two thousand dollars and a week can discover a critical flaw and a working exploit inside a package that thousands of projects depend on, "we'll trust this version because it's been published a while" becomes a weaker defense. As [CrowdStrike's CTO put it](https://www.anthropic.com/glasswing): *"The window between vulnerability discovery and exploitation has collapsed — now minutes with AI."*
