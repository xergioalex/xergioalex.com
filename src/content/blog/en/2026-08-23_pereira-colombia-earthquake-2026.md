...
And there is the other side of everything I said about the code. The code answers for how a building was built. For what gets done to it afterward, the owner answers: [modifying a building's structural system requires a construction permit](https://www.alcaldiabogota.gov.co/sisjur/normas/Norma1.jsp?i=336), and it's the curadurías and municipal offices that are supposed to demand it. The responsibility exists. What barely exists is the enforcement: nobody is going to knock on an apartment door to ask whether the wall they took down was load-bearing.
