...
On May 7, 2026 I stood on a stage at the **Universidad Tecnológica de Pereira** with a microphone in one hand and a pair of red lobster antennae on my head, telling the story of a project that went from a one-hour WhatsApp bot to one of the most important things to happen to open source all year: **OpenClaw**. The event was **FLISOL** — the *Festival Latinoamericano de Software Libre*, the largest free-software gathering in Latin America, run on the same day across dozens of cities — and this edition lived at UTP, hosted by the Facultad de Ingenierías alongside ASE UTP, QA CONF, Ubuntu Colombia, and FOREST.

I picked this story for this festival on purpose. OpenClaw isn't just a clever piece of software — it's an open-source story, and FLISOL is exactly the room where that part matters most.
...
That is a deeply free-software idea, which is why FLISOL felt like the right place to tell it. The whole point of a festival like this is that the tools shaping our lives should be open, inspectable, and owned by the people who use them. OpenClaw took that principle and aimed it at the one piece of software everyone is suddenly racing to control: the personal AI agent. I'd already written the full story in my deep-dive, [OpenClaw: Your Assistant. Your Machine. Your Rules.](/blog/openclaw-your-assistant-your-machine-your-rules/), and the slides for this session live in [the companion deck](/slides/openclaw-your-assistant-your-machine-your-rules/) — so on stage I could move fast and stay on the narrative.
...
<img src="/images/blog/posts/openclaw-flisol-talk/memories-02.webp"
     ...
     height="1280"
     loading="lazy" />
<figcaption>"Built in the open" — the four pillars I anchored the talk on: transparency, community, collaboration, freedom.</figcaption>
</figure>

## The story I told

OpenClaw's origin sounds made up, and that's half of why it's fun to tell. In November 2025 **Peter Steinberger** — the Austrian developer behind PSPDFKit, who had walked away from a successful company and then spent a couple of years burned out and unable to write code — got annoyed that he couldn't talk to Claude from WhatsApp. So he built a bridge in about an hour, asked Claude what to call it, got "Clawdbot," pushed it to GitHub, and went to sleep.

For two months almost nothing happened. Then late January 2026 hit and the curve broke physics: thousands of stars in a day, tens of thousands in a weekend, past React's decade-long total in roughly sixty days. I won't re-run every number here — that's what the [deep-dive](/blog/openclaw-your-assistant-your-machine-your-rules/) is for — but on stage the star-history chart did the work for me.

<figure>
<img src="/images/blog/posts/openclaw-flisol-talk/memories-03.webp"
     alt="Sergio at the screen showing the Star History chart comparing OpenClaw, React and Linux, with OpenClaw's line shooting almost vertically in 2026"
     width="960"
     height="1280"
     loading="lazy" />
...
Then came the part the room enjoyed most: the triple rebrand. A cease-and-desist from Anthropic (Clawdbot sounded too much like Claude), a 5am Discord rename to **Moltbot**, crypto scammers grabbing the freed-up handle to pump a fake `$CLAWD` token, a wave of harassment from the people they scammed — and, days later, a third and final name: **OpenClaw**. Three names in under a week, one lobster mascot that survived all of it.
...
And then the bigger point, the one I most wanted a free-software audience to sit with: OpenClaw didn't just grow — it dragged the whole ecosystem forward. Agents got their own social network (Moltbook, which Meta acquired three months after launch), their own payment, identity, and email infrastructure, an enterprise layer from NVIDIA (NemoClaw), and a swarm of community clones small enough to run on a Raspberry Pi. After OpenClaw, every big assistant had to add file access, real execution, and integrations just to keep up. An open-source weekend project reset the minimum bar for what "an agent" even means.

## What I left the room with

If there's one idea I wanted to land at FLISOL, it's that none of this came out of a boardroom. It came from one developer scratching his own itch, building in the open, and letting a community run with it. That's the oldest story in free software — Linux, WordPress, Wikipedia — and OpenClaw is just its newest, fastest chapter. The full argument is in [the deck](/slides/openclaw-your-assistant-your-machine-your-rules/) and the [deep-dive post](/blog/openclaw-your-assistant-your-machine-your-rules/); the short version is the one I closed on, borrowed from Peter himself: the lobster is loose, and it's not going back into the tank.
...
<img src="/images/blog/posts/openclaw-flisol-talk/memories-01.webp"
     ...
     height="1280"
     loading="lazy" />
<figcaption>Lobster antennae mandatory. Closing the session with the FLISOL edition poster.</figcaption>
</figure>
...
<img src="/images/blog/posts/openclaw-flisol-talk/memories-05.webp"
     ...
     height="1280"
     loading="lazy" />
<figcaption>On the "wild early days" — when OpenClaw felt like handling something powerful, not a toy in a life vest.</figcaption>
</figure>
...
- [FLISOL — Festival Latinoamericano de Software Libre](https://flisol.info/) — the event this talk was part of
