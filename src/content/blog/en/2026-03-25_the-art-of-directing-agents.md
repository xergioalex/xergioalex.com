...
There's a moment in Andrej Karpathy's [recent interview on No Priors](https://www.youtube.com/watch?v=kwSVtQ7dziU) that stuck with me. The interviewer asks him: *"Code's not even the right verb anymore, right?"* And Karpathy responds with a single word: *"Manifest."* That's his name for what we do now. Not coding. Not prompting. Manifesting — expressing your will to agents, shaping intent into action. I think he's onto something. That's closer to what it actually feels like than any other word I've heard. Others call it vibe coding — Karpathy himself coined the term a while back. But even that falls short. Vibe coding sounds casual, improvised, like you're just going with the flow. What I do every day is anything but casual. It's deliberate, structured, and it requires deeply understanding what you're asking for.
