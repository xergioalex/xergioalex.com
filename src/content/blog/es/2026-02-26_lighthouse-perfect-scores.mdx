...
description: "La historia detallada de cómo llevé XergioAleX.com de excelente a perfecto — logrando 100/100/100/100 en Google Lighthouse PageSpeed Insights para Performance, Accesibilidad, Mejores Prácticas y SEO, tanto en móvil como en escritorio."
pubDate: "2026-02-26"
...
[AUTHOR: ¿Cuánto tiempo tardó el Typewriter en CSS? ¿Probaste primero enfoques con JavaScript — GSAP, transiciones de Svelte? ¿Qué falló antes de que encontraras la solución en CSS puro? ¿Cómo se sintió cuando te diste cuenta de que el navegador ya podía hacerlo solo?]
...
![PageSpeed Insights — Móvil: 100 en Performance, Accesibilidad, Mejores Prácticas y SEO. Core Web Vitals: FCP 0.9s, LCP 1.5s, TBT 0ms, CLS 0, Speed Index 0.9s](/images/blog/posts/lighthouse-perfect-scores/pagespeed-mobile.png)

![PageSpeed Insights — Escritorio: 100 en Performance, Accesibilidad, Mejores Prácticas y SEO. Core Web Vitals: FCP 0.3s, LCP 0.3s, TBT 0ms, CLS 0, Speed Index 0.5s](/images/blog/posts/lighthouse-perfect-scores/pagespeed-desktop.png)
