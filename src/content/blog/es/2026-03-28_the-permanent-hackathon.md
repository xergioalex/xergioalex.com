---
title: "El Hackathon Permanente: Por Qué No Podemos Dejar de Construir"
description: "La IA iba a darnos más tiempo libre. En cambio creó un ciclo adictivo de construcción — neurociencia, economía y una confesión colectiva en un meetup."
pubDate: "2026-03-28"
...
- [Anna Lembke — Dopamine Nation](https://www.annalembke.com/dopamine-nation) — El marco de la medicina de adicciones de Stanford: equilibrio placer-dolor, tolerancia y el estado de déficit de dopamina
- [La IA no reduce el trabajo — lo intensifica (HBR)](https://hbr.org/2026/02/ai-doesnt-reduce-work-it-intensifies-it) — Estudio observacional de ocho meses documentando tres formas de intensificación del trabajo con IA
- [La paradoja de productividad de la IA: más trabajo, no menos (Fortune)](https://fortune.com/2026/03/10/ai-productivity-workers-workday-efficiency/) — Cómo los CTOs pasaron de "8 horas a 2" a hacer "20 horas de trabajo"
- [Cuando usar IA lleva al "brain fry" (HBR)](https://hbr.org/2026/03/when-using-ai-leads-to-brain-fry) — Fatiga por decisiones, tasas de error y el punto óptimo de máximo 3 herramientas de IA
- [Por qué el mundo de la IA está obsesionado con la paradoja de Jevons (NPR)](https://www.npr.org/sections/planet-money/2025/02/04/g-s1-46018/ai-deepseek-economics-jevons-paradox) — La paradoja económica de 160 años que explica por qué la eficiencia lleva a más consumo, no menos
- [El ciclo de búsqueda-recompensa de dopamina (Psychology Today)](https://www.psychologytoday.com/us/blog/brain-wise/201802/the-dopamine-seeking-reward-loop) — Por qué la anticipación genera más dopamina que la recompensa misma, y por qué el sistema del querer no tiene interruptor
- [Simon Willison — Cómo uso LLMs para escribir código](https://simonwillison.net/2025/Mar/11/using-llms-for-code/) — 77 apps construidas con prompts: "No se trata de velocidad — se trata de construir cosas que no habría justificado antes"
- [Rompiendo el hechizo del vibe coding (fast.ai)](https://www.fast.ai/posts/2026-01-28-dark-flow/) — Rachel Thomas sobre el "dark flow," la confesión de dos meses sin dormir de Armin Ronacher, y por qué el junk flow imita el crecimiento
- [Un prompt más: la trampa de dopamina del código agéntico](https://blog.quent.in/blog/2026/03/09/one-more-prompt-the-dopamine-trap-of-agentic-coding/) — El plan de escape nocturno de Steve Yegge, las confesiones de red bull de Garry Tan, y por qué el código agéntico "embruja" a la gente
- [La trampa de dopamina: la fuente de burnout raramente discutida (SUCCESS)](https://www.success.com/the-dopamine-trap-the-rarely-discussed-source-of-burnout-developers-face-in-an-ai-age) — La fibrilación auricular de Glenn Sanford tras sesiones de programación con IA de 16 horas y cómo se recuperó
- [Las primeras señales de burnout vienen de los mayores fans de la IA (TechCrunch)](https://techcrunch.com/2026/02/09/the-first-signs-of-burnout-are-coming-from-the-people-who-embrace-ai-the-most/) — Por qué los adoptantes más entusiastas de la IA son los primeros en quemarse
