...
Lo que me llama la atención es lo natural que se sintió todo. Nadie convocó una cumbre. Nadie publicó un manifiesto. Los agentes empezaron a necesitar comprar cosas, y la infraestructura apareció. Es como ver nacer un ecosistema — no diseñado, sino evolucionado. Cada pieza apareciendo porque la anterior la hizo necesaria.

---

## Los Agentes Tienen Billetera

Para que los agentes participen en una economía, necesitan lo más básico que necesita cualquier actor económico: una forma de pagar.

Esto ya está resuelto. Y la velocidad a la que ocurrió todavía me sorprende.

[Stripe lanzó los Shared Payment Tokens (SPTs)](https://stripe.com/blog/agentic-commerce-suite) — un primitivo de pago completamente nuevo. La idea: tu agente puede iniciar una compra usando tu método de pago guardado sin ver nunca el número de tu tarjeta. El token está limitado por vendedor, tiempo y monto. Cuando termina la transacción, el token expira. Es como una llave de un solo uso que abre exactamente una puerta y luego se autodestruye. Stripe incorporó a URBN, Etsy, Coach y Kate Spade, y proyecta [$385 mil millones en compras agénticas en EE.UU. para 2030](https://stripe.com/blog/agentic-commerce-suite).

Pero Stripe no está solo. Las guerras de las tarjetas de crédito se están repitiendo — esta vez por los agentes.

[Visa lanzó Intelligent Commerce](https://usa.visa.com/about-visa/newsroom/press-releases.releaseId.21961.html) con más de 100 socios y pilotos en Asia, Europa y América Latina. Su SVP lo dijo sin rodeos: *"In 2026, AI agents won't just assist your shopping — they will complete your purchases."* (En 2026, los agentes de IA no solo van a asistir tus compras — las van a completar.) Mientras tanto, [Mastercard y Santander completaron el primer pago en vivo de extremo a extremo ejecutado por un agente de IA en Europa](https://www.santander.com/en/press-room/press-releases/2026/03/santander-and-mastercard-complete-europes-first-live-end-to-end-payment-executed-by-an-ai-agent) — dentro de un marco bancario regulado. Un agente, haciendo un pago real, a través de un banco real. Ese es el momento "primera pizza de Bitcoin" de la economía de agentes.

En el lado corporativo, [Ramp lanzó Agent Cards](https://stabledash.com/news/2026-03-11-ramp-launches-agent-cards-to-enable-secure-autonomous-ai-spending) — dándole a los agentes de IA la capacidad de gastar dinero de empresa con límites reales, controles por comercio y rastros de auditoría completos. Y del lado startup, [AgentCard](https://agentcard.sh/) crea Mastercards virtuales de un solo uso por transacción — PAN, CVV y vencimiento únicos que se cancelan automáticamente después de usar. Una tarjeta de crédito desechable para la IA. Ese concepto no existía hace 12 meses.

En 2018 escribí sobre cómo blockchain eliminaría los intermediarios de los pagos. Lo que no predije fue que la primera gran revolución de pagos no vendría de eliminar intermediarios, sino de crear un nuevo tipo de comprador.

Piensa en lo que acaba de pasar en cuestión de unos pocos meses. Stripe creó un nuevo primitivo de pago. Visa y Mastercard están compitiendo para definir el estándar. Un banco europeo procesó el primer pago agéntico regulado. Las herramientas de finanzas corporativas se adaptaron para el gasto de IA. Las startups construyeron tarjetas de crédito desechables para bots. Y esto es solo el lado fiat — el cripto tiene su propia historia paralela.

---

## Dónde Encaja Blockchain de Verdad

Aquí es donde mi predicción de 2018 se pone interesante.

La economía de agentes no está construida puramente sobre blockchain — pero blockchain juega un papel que hubiera sido difícil de imaginar en ese entonces. No como los cimientos de una nueva moneda, sino como infraestructura para la liquidación entre agentes.

[Coinbase lanzó billeteras agénticas](https://www.coinbase.com/developer-platform/discover/launches/agentic-wallets) — la primera infraestructura de billetera diseñada específicamente para agentes de IA. Pueden guardar fondos, enviar pagos, tradear tokens, generar rendimientos y transaccionar on-chain. Las billeteras son no custodiales, aseguradas en Trusted Execution Environments. Construidas sobre el [protocolo x402](https://www.x402.org/), que ya ha procesado más de 50 millones de transacciones.

Y x402 es uno de mis detalles técnicos favoritos de todo esto. HTTP tiene un código de estado — [402 Payment Required](https://developer.mozilla.org/en-US/docs/Web/HTTP/Status/402) — desde los primeros días de la web. Estaba reservado "para uso futuro." Por más de 30 años, nadie lo usó. Ahora x402 lo resucita para exactamente lo que fue diseñado: pagos instantáneos con stablecoins sobre HTTP. Cuando un agente se encuentra con un paywall, automáticamente adjunta un pago firmado en stablecoin y la interacción continúa. Internet siempre fue diseñado para tener pagos nativos. Tomó a los agentes para que finalmente sucediera.
...
## Las Guerras de Protocolos

Para que una economía funcione, los participantes necesitan encontrarse, comunicarse y transaccionar. Los protocolos para esto se están definiendo ahora mismo — y es una carrera por el territorio.

[Google lanzó A2A](https://developers.googleblog.com/en/a2a-a-new-era-of-agent-interoperability/) (Agent-to-Agent) — un protocolo abierto para que agentes de distintos proveedores se descubran y colaboren entre sí. Usa "Agent Cards" — archivos JSON que describen qué puede hacer un agente — para que otros agentes encuentren al colaborador correcto para cada tarea. Más de 50 socios incluyendo Atlassian, PayPal, Salesforce, SAP y ServiceNow. Donado a la Linux Foundation.

El [MCP de Anthropic](https://www.anthropic.com/news/donating-the-model-context-protocol-and-establishing-of-the-agentic-ai-foundation) (Model Context Protocol) maneja la capa de integración de herramientas — cómo los agentes interactúan con servicios externos. Los números son impresionantes: 97 millones de descargas mensuales del SDK. Más de 10,000 servidores MCP activos. Integrado en ChatGPT, Cursor, Gemini, Microsoft Copilot y VS Code. Anthropic lo donó a la Agentic AI Foundation, cofundada con Block y OpenAI, y apoyada por Google, Microsoft y AWS. Cuando los competidores cofundan un organismo de estándares, sabes que las apuestas son altas. Yo uso MCP todos los días en mis proyectos — mis agentes se conectan a herramientas externas a través de él, y he construido servidores MCP personalizados para mis propios flujos de trabajo. Se ha vuelto tan invisible y esencial como HTTP mismo. No lo notas hasta que no está.

Luego están los protocolos de comercio. OpenAI y Stripe construyeron el [ACP (Agentic Commerce Protocol)](https://www.ekamoira.com/blog/what-is-agentic-commerce-the-complete-2026-guide-to-ai-shopping-agents), activo desde septiembre de 2025. Google respondió con el [UCP (Universal Commerce Protocol)](https://www.ekamoira.com/blog/what-is-agentic-commerce-the-complete-2026-guide-to-ai-shopping-agents) en enero de 2026. Google también lanzó el [AP2 (Agent Payments Protocol)](https://cloud.google.com/blog/products/ai-machine-learning/announcing-agents-to-payments-ap2-protocol) que se integra con el x402 de Coinbase — Big Tech y cripto convergiendo en los rieles de pago para agentes.

E incluso el [NIST — el organismo de estándares de EE.UU.](https://www.nist.gov/news-events/news/2026/02/announcing-ai-agent-standards-initiative-interoperable-and-secure) — ha lanzado una Iniciativa de Estándares para Agentes de IA. Tres pilares: estándares liderados por la industria, desarrollo de protocolos de código abierto, e investigación en seguridad e identidad. El gobierno ya está intentando regular una economía que apenas existe. Así de rápido se está moviendo todo.

La imagen que emerge es un stack económico para agentes:
...
| Pagos (fiat) | Los agentes compran cosas | Stripe SPTs, Visa, Mastercard |
...
Esa es la parte que se siente como ciencia ficción y realidad al mismo tiempo. Sigo oscilando entre "esto es increíble" y "esto se mueve tan rápido que nadie puede entenderlo del todo" — y creo que ambas sensaciones son correctas.

---

## Cuando los Agentes Se Convierten en Empleadores

Esta es la parte que pega diferente.
...
Jensen Huang [fue más lejos en el GTC 2026](https://www.cnbc.com/2026/03/20/nvidia-ai-agents-tokens-human-workers-engineer-jobs-unemployment-jensen-huang.html), presentando el concepto de "tokens de IA sobre el salario" — un futuro donde los trabajadores reciben tanto compensación tradicional como tokens de productividad generados por IA. Todavía no sé qué pensar de eso. Pero el hecho de que el CEO de la empresa más valiosa del mundo esté enmarcando públicamente la relación económica entre humanos y agentes te dice hacia dónde va esto.
...
No sé hacia dónde va esto. Nadie lo sabe. Pero sé que la infraestructura ya está aquí — pagos, identidad, comunicación, descubrimiento, gobernanza. Las piezas están en su lugar para que los agentes sean actores económicos plenos. Y algunos de ellos ya lo son.

En 2018, terminé mi artículo sobre blockchain con: "Todavía estamos en los días tempranos. Pero creo que estamos viendo los cimientos de algo grande siendo construido."

Diría lo mismo ahora. Tecnología diferente. Actores diferentes. La misma sensación.

La tesis de blockchain no estaba equivocada. Los agentes simplemente llegaron antes de que llegara la utopía blockchain. Y están construyendo la economía ellos mismos — sin esperar permiso, sin esperar estándares, sin esperar que alguien se ponga de acuerdo en un protocolo. Solo están... transaccionando. Y el mundo está corriendo para alcanzarlos.
...
- [Protocolo x402](https://www.x402.org/) — Pagos nativos en stablecoin sobre HTTP, resucitando el código de estado HTTP 402 de hace 30 años
- [Protocolo A2A de Google](https://developers.googleblog.com/en/a2a-a-new-era-of-agent-interoperability/) — Protocolo abierto de descubrimiento agente a agente con 50+ socios, donado a la Linux Foundation
- [MCP y la Agentic AI Foundation (Anthropic)](https://www.anthropic.com/news/donating-the-model-context-protocol-and-establishing-of-the-agentic-ai-foundation) — 97M+ descargas mensuales del SDK, cofundado por Anthropic, Block y OpenAI
- [The Agent Economy: A Blockchain-Based Foundation (arXiv)](https://arxiv.org/html/2602.14219v1) — Artículo académico que formaliza la arquitectura de cinco capas de la economía de agentes
- [AgentMail recauda $6M (TechCrunch)](https://techcrunch.com/2026/03/10/agentmail-raises-6m-to-build-an-email-service-for-ai-agents/) — Infraestructura de correo electrónico para agentes de IA: bandejas de entrada, hilos y más de 100M correos enviados
- [Iniciativa de Estándares de Agentes de IA del NIST](https://www.nist.gov/news-events/news/2026/02/announcing-ai-agent-standards-initiative-interoperable-and-secure) — El gobierno de EE.UU. estableciendo estándares de identidad, seguridad e interoperabilidad para agentes de IA
- [Los agentes de IA están contratando trabajadores humanos (Nature)](https://www.nature.com/articles/d41586-026-00454-7) — La inversión del empleador: agentes contratando científicos y "trabajadores del mundo físico" para tareas presenciales
- [Jensen Huang: Tokens de IA sobre el salario (CNBC)](https://www.cnbc.com/2026/03/20/nvidia-ai-agents-tokens-human-workers-engineer-jobs-unemployment-jensen-huang.html) — El CEO de NVIDIA enmarcando el futuro donde los humanos reciben compensación tradicional y tokens generados por IA
