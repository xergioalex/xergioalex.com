...
Los usuarios más pesados de la IA no son personas: son programas. Agentes, pipelines y paneles que le hacen a otras máquinas millones de preguntas pequeñas cada hora —qué equipo atiende este ticket, si esta transacción es sospechosa, si este mensaje necesita un humano—. Cada una de esas preguntas termina igual: en un condicional. Y hoy, todas se las responde modelos entrenados para escribir ensayos que nadie pidió.
