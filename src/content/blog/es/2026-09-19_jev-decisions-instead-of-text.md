...
Los fundadores de TypeSafe abren su primer de IA con una apuesta que suena absurda hasta que te sientas con ella: algo así como el 99% de las interacciones de IA terminarán siendo de máquina a máquina — y casi ninguna de esas máquinas necesita prosa. Necesitan criterio. Una cola enrutada, una transacción validada, un millón de decisiones pequeñas por hora terminando en un if, corriendo en silencio en el fondo de cada producto que usas. Hoy, casi todo ese criterio corre sobre modelos construidos para escribir ensayos. Entonces: ¿cómo sería el software si la IA dejara de hablar?

TypeSafe apostó la empresa a una respuesta. Su modelo insignia, Jev, no puede producir texto —no es que "lea mal": se niega por arquitectura—. Lee un estado: un ticket de soporte, un correo, un documento. Responde preguntas tipadas sobre ese estado y devuelve números —una elección, una puntuación, una probabilidad—. Nada que parsear, nada que suavizar. Números sobre los que tu código puede ramificar. Apuntado a una cola de soporte real, calificó quince juicios correctamente en 2.5 segundos. La factura completa: una centésima de centavo.
